  ...
  return (
    <div className="min-h-screen bg-[#F4F0E7] text-[#172638]">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[312px] px-4 py-4 xl:block">
        <div className="h-full overflow-hidden rounded-[28px] border border-[#D8CFBF] bg-[#FBFAF6] p-4 shadow-[0_26px_60px_rgba(49,88,66,0.16)]">
          <div className="flex items-center gap-3 border-b border-[#E2D8C8] pb-3">
            <div className="relative flex size-11 shrink-0 items-center justify-center rounded-2xl border border-[#C7A866]/35 bg-[#315842] text-white shadow-[0_10px_24px_rgba(49,88,66,0.18)]">
              <PawPrint className="size-5" />
              <span className="absolute -right-1 -top-1 size-3 rounded-full border border-white bg-[#C7A866]" />
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-black uppercase tracking-[0.24em] text-[#B08A46]">MyDogPortal</p>
          ...
          <div className="mx-auto flex max-w-[1560px] items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <form action={logoutAction}>
                <button className="flex h-11 items-center justify-center gap-2 rounded-xl border border-[#D8CFBF] bg-white px-4 text-sm font-black text-[#315842] shadow-sm transition hover:border-[#C7A866]/60 hover:bg-[#FFF7E6]"><LogOut className="size-4" />Log Out</button>
              </form>
            </div>
          </div>
        </header>
