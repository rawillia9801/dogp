      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <section className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <Card>
            ...
            <p className="mt-2 text-[#5d6c7d]">Each litter will show sire, dam, due date, puppy count, reservations, go-home milestones, and care tasks.</p>
            <div className="mt-6 rounded-[24px] border border-[#e7ddce] bg-[#fcfbf8] p-6 text-center">
              ...
              <p className="mt-4 font-black">No detailed litter cards loaded yet</p>
          ...
          <Card>
            ...
            <div className="mt-4 space-y-3">
              <Milestone icon={CalendarClock} title="Due dates" text="Upcoming whelping windows will appear here." />
        ...
        <section className="rounded-[28px] border border-[#e2d9ca] bg-gradient-to-r from-[#2f5d3f] to-[#466f54] p-6 text-white shadow-xl">
          <p className="font-bold">Premium litter flow is now installed.</p>
          <p className="mt-2 text-white/80">Next layer: live litter cards, puppy slots, reservation mapping, and whelping timeline.</p>
        </section>
      </div>
    </main>
  );
...
function Header({ title, subtitle, cta, href }: { title: string; subtitle: string; cta: string; href: string }) {
