    ...
    <main className="min-h-screen bg-[#f6f3ec] text-[#132238] p-8 md:p-12">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-5 rounded-[32px] border border-[#e2d9ca] bg-white p-8 shadow-[0_20px_60px_rgba(19,34,56,0.06)]">
          ...
          <Field label="Sire" />
          <Field label="Dam" />
          <Field label="Breeding Date" type="date" />
          <Field label="Due Date" type="date" />
          <Field label="Whelp Date" type="date" />
          <Field label="Puppies Born" type="number" />
          <Field label="Available Spots" type="number" />
          <Field label="Reserved Spots" type="number" />
          <Field label="Deposit Collected" />
          <div className="md:col-span-2"><label className="text-xs uppercase tracking-[0.22em] text-[#8a7757] font-semibold">Litter Notes</label><textarea rows={5} className="mt-2 w-full rounded-2xl border border-[#ddd2c0] bg-[#fcfbf8] px-4 py-3 outline-none" /></div>
