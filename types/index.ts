...
export type DogGeneticRecord = {
  id: string;
  organizationId: string;
  dogId: string;
  carrierStates: string | null;
  colorGenetics: string | null;
  coatGenetics: string | null;
...
export type BreedingPair = {
  ...
  expectedLitterSize: string | null;
  colorCoatSummary: string | null;
  reservationGoal: number | null;
  goals: string | null;
...
export type Buyer = {
  ...
  email: string;
  phone: string | null;
  status: "lead" | "approved" | "active" | "completed" | string;
  notes: string | null;
...
export type BuyerPayment = {
  ...
  type: "deposit" | "installment" | "adjustment" | string;
  method: string | null;
  status: string;
  createdAt: string;
  updatedAt: string;
...
export type BuyerDocument = {
  ...
  buyerId: string | null;
  title: string;
  category: "contracts" | "payment plan" | "health" | "delivery" | string;
  fileUrl: string | null;
  status: string;
...
export type TransportationRequest = {
  ...
  buyerId: string | null;
  puppyId: string | null;
  type: "pickup" | "meet" | "delivery" | string;
  date: string | null;
...
export type NoticeLog = {
  ...
  sentAt: string | null;
  deliveryStatus: "scheduled" | "queued" | "sent" | "delivered" | "failed" | "skipped" | "canceled" | string;
...
export type AutomationSettings = {
  ...
  paymentNoticesEnabled: boolean;
  documentNoticesEnabled: boolean;
  transportationNoticesEnabled: boolean;
  puppyMilestoneNoticesEnabled: boolean;
  providerName: string;
